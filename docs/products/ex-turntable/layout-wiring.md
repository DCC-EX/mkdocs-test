...
On this page we hope to outline various different ways to connect your turntable to **EX-Turntable** and your layout to ensure correct DCC phase alignment with the surrounding tracks.

Given **EX-Turntable** is in its infancy at the time of writing, there will likely be plenty of other options available or in use that we've not been made aware of as yet. We will capture those here in due course.
...
![Layout connection with split centre ring](../../_static/images/ex-turntable/layout-connection-split-ring.png){ width=400ps }
...
Assuming that the default behaviour of automatic phase switching is enabled, when the turntable rotates 180 degrees, **EX-Turntable** will automatically activate the relays, resulting in the CommandStation + connecting to the orange inner ring, and the - connecting to the brown outer ring, reversing the phase and preventing a short circuit from occurring.

![Layout connection with centre rings](../../_static/images/ex-turntable/layout-connection-centre-rings.png){ width=400ps }
...
Assuming that the default behaviour of automatic phase switching is enabled, when the turntable rotates 180 degrees, **EX-Turntable** will automatically activate the relays, resulting in the CommandStation + connecting to the orange pit rail, and the - connecting to the brown centre ring, reversing the phase and preventing a short circuit from occurring.
