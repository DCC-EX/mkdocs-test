...
* I2C (I<sup>2</sup>C) device driver
...
!!!note "Full step, half step, and other modes"
...
Refer to the [Test and tune](test-and-tune.md) page for details on how to configure and control **EX-Turntable**.
...
!!! warning "single step (or microstep) in one go"
...
!!! warning "DCC phase (or polarity) is not aligned"
...
![No rotation](../../_static/images/ex-turntable/0degree-phase.png){ width=400px }

![90 degrees](../../_static/images/ex-turntable/90degree-no-phase-change.png){ width=400px }

![180 degrees](../../_static/images/ex-turntable/180degree-no-phase-change.png){ width=400px }
...
![90 degrees](../../_static/images/ex-turntable/90degree-phase-change.png){ width=400px }

![180 degrees](../../_static/images/ex-turntable/180degree-phase-change.png){ width=400px }
...
![Aligned with first track](../../_static/images/ex-turntable/auto-phase-switch-start.png){ width=400px }
...
![Rotate beyond 45 degrees](../../_static/images/ex-turntable/auto-phase-switch-trigger.png){ width=400px }
...
![Rotated 180 degrees](/_static/images/ex-turntable/auto-phase-switch-end.png){ width=400px }

If the turntable continues to rotate beyond the 225 degree point, the phase will revert again.

![Rotated 180 degrees](../../_static/images/ex-turntable/auto-phase-switch-revert.png){ width=400px }
...
If you have a layout that requires more control over when phase switching does and doesn't happen, you can configure manual phase switching, as outlined in [Manual Tuning Phase](test-and-tune.md#manual-phase-switching).
