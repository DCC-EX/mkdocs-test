...
Lets suppose you have a turnout/point ID 100 and to make it look realistic you need to set some signal to stop, wait for the signalman to walk accross the lever frame, throw the turnout/point, wait again and set another signal to green.
