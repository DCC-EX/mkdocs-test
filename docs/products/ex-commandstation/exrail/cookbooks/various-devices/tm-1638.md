...
CAUTION: This boards require several GPIO pins on the **EX-CommandStation** but as speed is unimportant, these 3 may be VPINS on another hardware expander such as an MCP23017.

The TM1638 board provides a very cheap way of implementing 8 buttons, 8 leds and an 8 digit 7segment display in a package requiring just 5 Dupont wires (vcc, gnd + 3 GPIO pins) from the **EX-CommandStation** without soldering.
