...
DCC-EX provides some tricks to switch tracks in software, perhaps because you only have a single loco or your PROG track is actually an isolated siding on a layout. See [Track Manager](/products/ex-commandstation/trackmanager/00-trackmanager.md)
...
See [Programming with Serial commands](/products/ex-commandstation/loco-programming/10-serial-programming.md)
...
See [Programming with Engine Driver](/products/ex-commandstation/loco-programming/20-engine-driver-programming.md)
...
See [Programming with EX-Toolbox](/products/ex-commandstation/loco-programming/30-toolbox-programming.md)
...
See [Programming with DecoderPro](/products/ex-commandstation/loco-programming/40-decoderpro.md)
