...
```markdown
[Link to Contributing to Documentation Page](/contributing/documentation/index.md)
```

Results in: [Link to Contributing to Documentation Page](/contributing/documentation/index.md)

```markdown
[Link to How to Contribute Section](/contributing/documentation/index.md#how-to-contribute)
```
