...
| [docs/reference/hardware/hal/hal-config.md](../reference/hardware/hal/hal-config.md) | 185 | This will need to be done in the ==TODO== :doc:`Arduino-IDE </ex-commandstation/advanced-setup/installation-options/arduino-ide>`, so first make sure you have followed these steps to load up the Arduino IDE. |
