...
![Turntable Positions](../../../../../_static/images/big-picture/stage5-ex-tt-positions.png){ width=400px }
...
![Turntable Wiring](../../../../../_static/images/big-picture/stage5-ex-tt-wiring.png){ width=400px }
...
| Position | Description | Degrees from home | Calculation | Step count |
| -------- | ----------- | ----------------- | ----------- | ---------- |
| 1 | Roundhouse stall 1 | 10 | 4097 / 360 * 10 | 114 |
| 2 | Roundhouse stall 2 | 20 | 4097 / 360 * 20 | 228 |
| 3 | Roundhouse stall 3 | 30 | 4097 / 360 * 30 | 344 |
| 4 | Roundhouse stall 4 | 40 | 4097 / 360 * 40 | 459 |
| 5 | Roundhouse stall 5 | 50 | 4097 / 360 * 50 | 573 |
| 6 | Roundhouse stall 6 | 60 | 4097 / 360 * 60 | 688 |
| 7 | Yard connection | 220 | 4097 / 360 * 220 | 2523 |
...
![Traverser Positions](../../../../../_static/images/big-picture/stage5-ex-traverser.png){ width-=300px }
...
| Position | Description | Calculation | Step count |
| -------- | ----------- | ----------- | ---------- |
| 1 | Staging 1 | 0 + 100 (home + buffer) | 100 |
| 2 | Staging 2 | 100 + 599.4 (position 1 + gap) | 699 |
| 3 | Staging 3 | 100 + 1198.8 (position 1 + 2 * gap) | 1299 |
| 4 | Staging 4 | 100 + 1798.2 (position 1 + 3 * gap) | 1898 |
| 5 | Staging 5 | 100 + 2397.6 (position 1 + 4 * gap) | 2498 |
| 6 | Staging 6 | 4097 - 100 (limit - buffer) | 3097 |
...
The diagnostic commands to move to our calculated turntable positions:

| Position | Description | Command |
| -------- | ----------- | ------- |
| 1 | Roundhouse stall 1 | ``<D TT 600 114 0>`` |
| 2 | Roundhouse stall 2 | ``<D TT 600 228 0>`` |
| 3 | Roundhouse stall 3 | ``<D TT 600 344 0>`` |
| 4 | Roundhouse stall 4 | ``<D TT 600 459 0>`` |
| 5 | Roundhouse stall 5 | ``<D TT 600 573 0>`` |
| 6 | Roundhouse stall 6 | ``<D TT 600 688 0>`` |
| 7 | Yard connection | ``<D TT 600 2523 0>`` |
| 0 | Home turntable | ``<D TT 600 0 2>`` |

  The last command will move to the home position.

The diagnostic commands to move to our calculated traverser positions:

| Position | Description | Command |
| -------- | ----------- | ------- |
| 1 | Staging 1 | ``<D TT 601 100 0>`` |
| 2 | Staging 2 | ``<D TT 601 699 0>`` |
| 3 | Staging 3 | ``<D TT 601 1299 0>`` |
| 4 | Staging 4 | ``<D TT 601 1898 0>`` |
| 5 | Staging 5 | ``<D TT 601 2498 0>`` |
| 6 | Staging 6 | ``<D TT 601 3097 0>`` |
| 0 | Home traverser | ``<D TT 601 0 2>`` |
...
The **EXRAIL** version of our diagnostic commands:

| Position | Description | Command |
| -------- | ----------- | ------- |
| 1 | Roundhouse stall 1 | ``MOVETT(600, 114, 0)`` |
| 2 | Roundhouse stall 2 | ``MOVETT(600, 228, 0)`` |
| 3 | Roundhouse stall 3 | ``MOVETT(600, 344, 0)`` |
| 4 | Roundhouse stall 4 | ``MOVETT(600, 459, 0)`` |
| 5 | Roundhouse stall 5 | ``MOVETT(600, 573, 0)`` |
| 6 | Roundhouse stall 6 | ``MOVETT(600, 688, 0)`` |
| 7 | Yard connection | ``MOVETT(600, 2523, 0)`` |
| 0 | Home turntable | ``MOVETT(600, 0, 2)`` |
| 1 | Staging 1 | ``MOVETT(601, 100, 0)`` |
| 2 | Staging 2 | ``MOVETT(601, 699, 0)`` |
| 3 | Staging 3 | ``MOVETT(601, 1299, 0)`` |
| 4 | Staging 4 | ``MOVETT(601, 1898, 0)`` |
| 5 | Staging 5 | ``MOVETT(601, 2498, 0)`` |
| 6 | Staging 6 | ``MOVETT(601, 3097, 0)`` |
| 0 | Home traverser | ``MOVETT(601, 0, 2)`` |
...
* ``DONE`` - this is our mandatory termination line for a ROUTE as required by **EXRAIL**
...
We also know how to control our **EX-Turntable** by both the interactive diagnostic commands as well as via **EXRAIL**.
...
As per our our **EXRAIL** routes explanation, these are based on the "myEX-Turntable.example.h" included with the **EX-CommandStation** software.

* [Example - Turntable ROUTEs](stage5-examples/turntable-example_not_in_nav.md)
* [Example - Turntable and traverser ROUTEs](stage5-examples/traverser-example_not_in_nav.md)
