...
The core components of an **EX-CommandStation** are:

- A microcontroller
- A Motor Driver
- *optionally*, a WiFi or Ethernet board
...
## Quick and Easy Arduino Mega Build ![Tinkerer Icon](../_static/images/levels/tinkerer.png){ .header-img } <br/><small>Intermediate Level</small>
...
## Slightly more difficult Mega Build ![Tinkerer Icon](../_static/images/levels/tinkerer.png){ .header-img } <br/><small>Intermediate Level</small>

Using other supported motor or WiFi shields requires a slightly [more complex setup](mega-harder.md).

## More difficult, but rewarding, ESP32 or Nucleo builds ![Engineer Icon](../_static/images/levels/engineer.png){ .header-img } <br/><small>Advanced Level</small>

The ESP32 or Nucleo microcontrollers offer significant performance benefits to the Arduino Mega but to build an **EX-CommandStation** with them is more complicated.

See the [Complex Build - Nucleo](nucleo.md) or [Complex Build - ESP32](esp32.md) pages for more information.
