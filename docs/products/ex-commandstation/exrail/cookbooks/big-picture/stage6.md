...
For more information on aliases, refer to [EXRAIL Aliases](../editing-tricks/general-tips.md#aliases-user-friendly-names-for-any-ids).
...
When the **EX-CommandStation** and **EXRAIL** starts, everything defined before the first ``DONE`` command executes automatically.
...
As outlined above in the [startup sequence](#startup-sequence) section, everything before the first ``DONE`` in myAutomation.h is executed on start up.
...
Once done, train control is over to the [moving from block 4 to block 1 - the speed run](#moving-from-block-4-to-block-1-the-speed-run) sequence.
...
* [ROUTEs with DCC accessory turnouts/points and signals on Mega2560 direct I/O pins](stage6-examples/example1_not_in_nav.md)
* [ROUTEs with turnouts/points/signals on Mega2560 direct I/O pins](stage6-examples/example2_not_in_nav.md)
* [ROUTEs with turnouts/points/signals on MCP23017 I/O expander Vpins](stage6-examples/example3_not_in_nav.md)
* [ROUTEs with servo based turnouts/points/signals on a PCA9685 servo module](stage6-examples/example4_not_in_nav.md)
* [Full automation with pin based turnouts/points and signals on Mega2560 direct I/O pins](stage6-examples/example5_not_in_nav.md)
* [Full automation with pin based turnouts/points and signals on MCP23017 I/O expander Vpins ](stage6-examples/example6_not_in_nav.md)
* [Full automation with servo based turnouts/points and signals with a PCA9685 servo module](stage6-examples/example7_not_in_nav.md)
