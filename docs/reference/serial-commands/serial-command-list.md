...
In many cases the parameters are self explanatory. For example a *tSpeed* will always be **-1..127** where **0**=stop and **-1**=emergency stop. (See the [Overview](./index.md) for more information on this and other common elements.)
