...
| **`p#`**<br>p2 | `<Np #>` | **Position table for a bank of sensors** <br>List for enAbled sensors of bank #. Also **p%%** |
...
| **`t##[,%%]`**<br>t42,12 | `<Nt ##[ %%]>` | **Theshold value (32-98) [pvtThreshold for S%%]** <br>Sets global threshold. [**t0,%%** removes pvtT.] |
...
| **`@##`**<br>@73 | <na> | **change scroll trip symbol - refer to manual**<br><span style="opacity:0">EXISensorCAMIversionIinfoIIvIIstartsISSIDIIIwebCAMIII</span> |
