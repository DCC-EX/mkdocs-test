...
- [<small>``<C RAILCOM ON|OFF>``</small> <br/> Enable/Disable Railcom cutout](reference/serial-commands/serial-command-c-railcom_not_in_nav.md)
...
- [<small>``<E>`` ``<e>`` ``<D EPROM [«numEntries»]>``</small> <br/> Manage EEPROM <small>(Arduino Mega Only)</small>](reference/serial-commands/serial-command-dd_and_e_and_ee_not_in_nav.md)
...
- [<small>``<J C [«mmmm» [«nn»]]>``</small> <br/> Get/Set the Fastclock Time](reference/serial-commands/serial-command-jj-cc_not_in_nav.md)
...
- [<small>``<m LINEAR|POWER|[«loco» «momentum»|«accelerating» [«braking»]]>``</small> <br/> Set the server based momentum](reference/serial-commands/serial-command-m_not_in_nav.md)
