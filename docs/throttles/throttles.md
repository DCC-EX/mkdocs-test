...
- [RtDrive DCC-EX (Android)](https://play.google.com/store/apps/details?id=net.rt2c.rtdrivedcc&hl=en_AU&gl=US)
...
Note: The Android throttle apps listed above can be made to made to run on Windows PCs. See [Running Android apps on Microsoft Windows](./android-apps-on-windows-and-ios_not_in_nav.md).
</div>
...
- [DCC Commander](https://apps.apple.com/us/app/dcc-commander/id6498150761) (iOS)
...
- [LoDi-Con WiFi Throttle](https://lokstoredigital.jimdoweb.com/lodi-con/) (Physical DIY)
- [miniThrottle](https://camelthorn.cloud/miniThrottle/miniIntro.php) (Physical DIY)
- TCS [UWT-50](https://tcsdcc.com/uwt-50) and [UTW-100](https://www.tcsdcc.com/uwt-100) (Physical Commercial)
- [WiTcontroller](https://github.com/flash62au/WiTcontroller) (Physical DIY)
- [DCC-EX Simple Throttle](https://petegsx-projects.github.io/simple-throttle/index.html) (Physical)
- [wiFred](https://newheiko.github.io/wiFred/documentation/docu_en.html) (Physical DIY)
- [DccExController](https://github.com/flash62au/DccExController) (Physical DIY) - ***Support Discontinued***

<div style="padding-left: 30px;" markdown="1">
See also: Arduino/ESP32 DCC-EX Native command library - [DCCEXProtocol](https://github.com/DCC-EX/DCCEXProtocol).
</div>
...
- [miniThrottle](https://camelthorn.cloud/miniThrottle/miniIntro.php) (Physical DIY)
- [DCC Commander](https://apps.apple.com/us/app/dcc-commander/id6498150761) (iOS)
- [DCC-EX Simple Throttle](https://petegsx-projects.github.io/simple-throttle/index.html) (Physical DIY)
- [DccExController](https://github.com/flash62au/DccExController) (Physical DIY) - ***Support Discontinued***
...
- [LoDi-Con WiFi Throttle](https://lokstoredigital.jimdoweb.com/lodi-con/) (Physical DIY)
- [miniThrottle](https://camelthorn.cloud/miniThrottle/miniIntro.php) (Physical DIY)
- TCS [UWT-50](https://tcsdcc.com/uwt-50) and [UWT-100](https://www.tcsdcc.com/uwt-100) (Physical Commercial)
- [WiTcontroller](https://github.com/flash62au/WiTcontroller) (Physical DIY)
- [wiFred](https://newheiko.github.io/wiFred/documentation/docu_en.html) (Physical DIY)
...
<div style="padding-left: 30px;" markdown="1">
Also see: Connect WiFi Throttle via USB
</div>
...
| Name                                                                                               | Licence         | Interface      | Protocol     | UI         | Also <br/> Requires  | Physical<br/>Device | Android | iOS | Windows | MacOS | Linux | CV <br/>Programming |
| -------------------------------------------------------------------------------------------------- | --------------- | -------------- | ------------ | ---------- | -------------------- | :-----------------: | :-----: | :-: | :-----: | :---: | :---: | :-----------------: |
| [EX-WebThrottle](../products/ex-webthrottle/ex-webthrottle.md)                                     | Free            | USB            | Native / WiT | Web        | -                    | -                   | -       | -   | X       | X     | X     | X                   |
| [JMRI](https://www.jmri.org/)                                                                      | Free            | USB / WiFi[^4] | Native       | App & Web  | JMRI[^3] on PC/RPi   | -                   | Web     | Web | X       | X     | X     | X                   |
| [Railroad Automation](https://www.perecli.com/rrauto/)                                             | Free            | WiFi / LocoNet | LocoNet      | Web        | IoTT Red hat         | -                   | Web     | Web | X       | X     | X     | -                   |
| [Engine Driver](./engine-driver.md)                                                                | Free            | WiFi           | Native / Wit | App        | -                    | -                   | X       | -   | -       | -     | -     | X [^1]              |
| [Cab Engineer: DCC Throttle](https://www.alfray.com/trains/cab_app.html)                           | Free            | WiFi           | Native       | App        | -                    | -                   | X       | -   | -       | -     | -     | -                   |
| [DCC++ Throttle](https://aleksandr.ru/my/dccppthrottle)                                            | Free            | WiFi / BT      | Native       | App        | -                    | -                   | X       | -   | -       | -     | -     | X                   |
| [DCC++ Throttle](https://aleksandr.ru/my/dccppthrottle)                                            | Free            | BT             | Native       | App        | -                    | -                   | X       | -   | -       | -     | -     | X                   |
| [RtDrive DCC-EX](https://play.google.com/store/apps/details?id=net.rt2c.rtdrivedcc)                | Free            | WiFi           | Native       | App        | -                    | -                   | X       | -   | -       | -     | -     | X                   |
| [DigiTrainsPro](https://play.google.com/store/apps/details?id=digitrainspro.digitrainspro.hu)      | Free / Paid     | WiFi           | JMRI Web     | App        | JMRI on PC/RPi       | -                   | X       | X   | X       | -     | -     | -                   |
| [Locontrol](https://apps.apple.com/us/app/locontrol-dcc-controller/id1473757920)                   | Free / Paid     | Net            | WiT          | App        | -                    | -                   | -       | X   | -       | -     | -     | -                   |
| [SRCP Client](https://www.io-expert.com/srcpclientios/index.html)                                  | Free            | WiFi           | Native       | App        | -                    | -                   | -       | X   | -       | -     | -     | -                   |
| [ThrottleCard](https://throttlecard.com/)                                                          | Free / Paid     | WiFi           | Native / WiT | App        | -                    | -                   | -       | X   | -       | X     | -     | X                   |
...
| [WiThrottle Cab](https://play.google.com/store/apps/details?id=com.gothicmaestro.withrottlecab)    | Paid            | WiFi           | Native       | App        | -                    | -                   | X       | X   | -       | -     | -     | -                   |
| [DccExController](https://github.com/flash62au/DccExController)                                    | Open Source     | WiFi           | Native       | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [DCC-EX Simple Throttle](https://petegsx-projects.github.io/simple-throttle/index.html)            | Open Source     | WiFi           | Native       | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [Elgato Stream Deck](https://github.com/daniep01/companion-module-dcc-ex-commandstation)           | Paid            | WiFi           | Native       | Device     | PC/RPi               | X                   | -       | -   | -       | -     | -     | -                   |
| [EX-T3-WiFi](https://github.com/DCC-EX/EX-T3-WiFi?tab=readme-ov-file)                              | Open Source     | WiFi           | Native       | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [HandCab](https://github.com/1fatgmc/HandCab/tree/main)                                            | Open Source     | WiFi           | WiT          | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [LoDi-Con WiFi Throttle](https://lokstoredigital.jimdoweb.com/lodi-con/)                           | Paid            | WiFi           | WiT          | Device     | -                    | X                   | -       | -   | -       | -     | -     | -                   |
| [miniThrottle](https://camelthorn.cloud/miniThrottle/miniIntro.php)                                | Open Source     | WiFi / USB     | Native       | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [myBluePillThrottle7](https://github.com/n1ksn/dcc-ex-bluepill-throttle-7)                         | Open Source     | Serial         | Native       | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [WiTcontroller](https://github.com/flash62au/WiTcontroller)                                        | Open Source     | WiFi           | WiT          | Device     | DIY                  | X                   | -       | -   | -       | -     | -     | -                   |
| [wiFred](https://newheiko.github.io/wiFred/documentation/docu_en.html)                             | Open Source     | WiFi           | WiT          | Device     | DIY                  | X                   | -       | -   | -       | -     | -     |  -                  |
| [TCS UWT-50](https://tcsdcc.com/uwt-50) & [UWT-100](https://www.tcsdcc.com/uwt-100)                | Paid            | WiFi           | WiT          | Device     | -                    | X                   | -       | -   | -       | -     | -     |  -                  |
| [ESU Mobile Control Pro](https://www.esu.eu/en/products/digital-control/mobile-control-pro/)       | Paid            | WiFi           | WiT / Native | Device     | -                    | X                   | ?[^7]   | -   | -       | -     | -     | X                   |
...
- Android = A phone or tablet running the Google Android operating system. [^2]
